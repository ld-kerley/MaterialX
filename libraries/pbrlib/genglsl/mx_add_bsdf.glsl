void mx_add_bsdf_impl(BSDF in1, BSDF in2, out BSDF result)
{
...
{
    mx_add_bsdf_impl(in1, in2, result);
}
...
void mx_add_bsdf(int closureType, vec3 _unused1, vec3 _unused2, vec3 _unused3, float weight, BSDF in1, BSDF in2, out BSDF result)
{
